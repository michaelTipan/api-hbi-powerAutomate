...
AUDIENCE_BY_CODE: dict[str, MessageAudience] = {
    ...
    "PDF_TEXT_NOT_EXTRACTABLE": "SECRETARY_CAN_CORRECT",
    "ACCOUNTING_PARSE_FAILED": "SECRETARY_CAN_CORRECT",
    "MISSING_BANK_VALUE_BUT_HAS_ACCOUNTING_LINES": "SECRETARY_CAN_CORRECT",
