...
class UiFeatureFlags:
    ...
    def history_allowed(self) -> bool:
        """Nav/API Historial. Default off; no afecta archivo SharePoint al Apply."""
        return self.ui_enabled and self.ui_history_enabled
...
def get_ui_feature_flags() -> UiFeatureFlags:
    ...
    history = _env_bool_strict_default_false("UI_HISTORY_ENABLED")
    ...
    return UiFeatureFlags(
        ...
        ui_history_enabled=history if effective_enabled else False,
