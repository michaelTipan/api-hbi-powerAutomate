...
const TECH_CODE_GROUP_LABELS: Record<string, string> = {
  ...
  RETENCIONES_COLUMN_MISSING: "Falta columna de retenciones",
  AMORTIZATION_TABLE_CHANGED_REQUIRES_REVALIDATION: "La tabla cambió",
  ASIENTO_ASSIGNMENT_AMBIGUOUS: "Asientos ambiguos",
  ASIENTO_ASSIGNMENT_NO_MATCH: "Asientos que no cuadran",
  ASIENTO_ASSIGNMENT_PARSE_FAILED: "Asiento no legible",
  ASIENTO_ASSIGNMENT_COMPLEXITY_LIMIT: "Demasiadas combinaciones de asientos",
  extract_routes_missing: "Falta extracto",
